...
//
const projects = ['converter', 'react-tasks/task1', 'react-tasks/task-2', 'react-tasks/task-3', 'react-tasks/task-4', ,'react-tasks/task-5','react-tasks/task-6','react-tasks/task-7', 'react-tasks/task-8', 'angular'];
